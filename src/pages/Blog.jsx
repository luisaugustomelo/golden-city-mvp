...
function Blog() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-gray-900 py-16">
      <div className="container">
        ...
        >
          <h1 className="text-4xl font-bold mb-4 text-sapphire-800 dark:text-gray-100">Real Estate & Crypto Insights</h1>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/30 p-6 border dark:border-gray-700/50">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-secondary-400 dark:text-gray-500" />
                  <input
                    type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/30 overflow-hidden border dark:border-gray-700/50 hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all duration-300"
            >
