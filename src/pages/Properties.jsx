...
function Properties() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sapphire-50 via-white to-platinum-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      {/* Header */}
      <div className="glass-nav">
        <div className="container py-6">
          <div className="flex justify-between items-center">
            <h1 className="text-3xl font-bold text-sapphire-800 dark:text-gray-100">Investment Properties</h1>
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-xl transition-all duration-300 ${showFilters ? 'glass-card text-primary-600 dark:text-primary-400' : 'hover:bg-glass dark:hover:bg-gray-800/30'}`}
        ...
        <div className="glass-card border-t border-glass">
          <div className="container py-6">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
              <div>
                <label className="block text-sm font-medium text-sapphire-700 dark:text-gray-300 mb-1">
                  Price Range
                </label>
                <select
                  className="input"
              ...
              <Link to={`/properties/${property.id}`}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div>
                      <p className="text-sm text-platinum-500 dark:text-gray-500">Investment Price</p>
                      <div className="flex items-center">
                        <FiDollarSign className="text-primary-600 dark:text-primary-400" />
                        <span className="font-semibold text-sapphire-800 dark:text-gray-100">${property.price.usd.toLocaleString()}</span>
                      </div>
                    ...
                    <div className="text-right">
                      <p className="text-sm text-platinum-500 dark:text-gray-500">Annual ROI</p>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      <span className="text-platinum-600 dark:text-gray-400">Monthly Income</span>
                      <span className="font-medium text-sapphire-700 dark:text-gray-300">{property.metrics.monthlyIncome}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-platinum-600 dark:text-gray-400">Appreciation</span>
                      <span className="font-medium text-sapphire-700 dark:text-gray-300">{property.metrics.appreciation}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-platinum-600">Funding Progress</span>
                      <span className="font-medium text-sapphire-700">{property.metrics.funded}</span>
                    </div>
                    <div className="w-full bg-platinum-100 rounded-full h-2">
                      <div
                  ...
                  {/* Token Details */}
                  <div className="glass-card bg-sapphire-50/50 p-3 mb-4">
                    <div className="flex justify-between text-sm">
                      <span className="text-platinum-600">Available Tokens</span>
                    ...
                    <div className="flex justify-between text-sm mt-1">
                      <span className="text-platinum-600">Token Price</span>
                      <span className="font-medium text-sapphire-700">{property.tokenDetails.tokenPrice}</span>
                    </div>
                  </div>
