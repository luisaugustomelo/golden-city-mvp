  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-gray-900 py-16">
      <div className="container">
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-4 text-sapphire-800 dark:text-gray-100">Frequently Asked Questions</h1>
          <p className="text-secondary-600 dark:text-gray-400 text-center mb-12">
            Find answers to common questions about our platform, cryptocurrency payments, and real estate investment.
          </p>

          <div className="space-y-8">
            {faqSections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-900/30 overflow-hidden border dark:border-gray-700/50">
                <h2 className="text-xl font-semibold p-6 bg-secondary-50 dark:bg-gray-800 text-sapphire-800 dark:text-gray-100">
                  {section.title}
                </h2>
